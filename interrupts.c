...
//            EnergyCh0[array_counter] = ProcessADCSamples(&BufferB_regs.channel[0][0],&BufferA_regs.channel[0][0], CHANNELA0_OFFSET, 0);
//            EnergyCh1[array_counter] = ProcessADCSamples(&BufferB_regs.channel[1][0],&BufferA_regs.channel[1][0], CHANNELA1_OFFSET, 1);
//            EnergyCh2[array_counter] = ProcessADCSamples(&BufferB_regs.channel[2][0],&BufferA_regs.channel[2][0], CHANNELA2_OFFSET, 2);
//            EnergyCh3[array_counter] = ProcessADCSamples(&BufferB_regs.channel[3][0],&BufferA_regs.channel[3][0], CHANNELA3_OFFSET, 3);
//
//        }else{
//
//            EnergyCh0[array_counter] = ProcessADCSamples(&BufferA_regs.channel[0][0],&BufferB_regs.channel[0][0], CHANNELA0_OFFSET, 0);
//            EnergyCh1[array_counter] = ProcessADCSamples(&BufferA_regs.channel[1][0],&BufferB_regs.channel[1][0], CHANNELA1_OFFSET, 1);
//            EnergyCh2[array_counter] = ProcessADCSamples(&BufferA_regs.channel[2][0],&BufferB_regs.channel[2][0], CHANNELA2_OFFSET, 2);
//            EnergyCh3[array_counter] = ProcessADCSamples(&BufferA_regs.channel[3][0],&BufferB_regs.channel[3][0], CHANNELA3_OFFSET, 3);
//
//        }
//    }else{
//
...
//    if( array_counter == CHANNEL_ENERGY_ARRAY){
//        int i =0;
//        float energySumCh0 = 0;
//        float energySumCh1 = 0;
//        float energySumCh2 = 0;
//        float energySumCh3 = 0;
//        for( ; i<CHANNEL_ENERGY_ARRAY; i++){
//            energySumCh0 = energySumCh0 + EnergyCh0[i];
//            energySumCh1 = energySumCh1 + EnergyCh1[i];
//            energySumCh2 = energySumCh2 + EnergyCh2[i];
//            energySumCh3 = energySumCh3 + EnergyCh3[i];
//        }
//
//        if(energySumCh0 > energySumCh1){
//            if(energySumCh0 > energySumCh2){
//                if(energySumCh0 > energySumCh3){
//                    //channel 0 is the highest
//                }else{
//                    //channel 3 is the highest
//                }
//            }else{
//                if(energySumCh2 > energySumCh3){
//                    //channel 2 is the highest
//                }else{
//                    //channel 3 is the highest
//                }
//            }
//        }else{
//            if(energySumCh1 > energySumCh2){
//                if(energySumCh1 > energySumCh3){
//                    //channel 1 is the highest
//                }else{
//                    //channel 3 is the highest
//                }
//            }else{
